...
describe("WordleBoard", () => {
    ...
    describe("End of the game messages", () => {
        ...
        ])("a defeat message appears if the user makes 6 guesses that are incorrect", ({numberOfGuesses, shouldSeeDefeatMessage}) => {

            test(`therefore for ${numberOfGuesses} guesses, the defeat message should ${shouldSeeDefeatMessage? "" : "not "}appear`, async() => {
    ...
    describe("Player input", () => {
        ...
        test("the inputs are cleared after a guess is submitted", async () => {
    ...
    test("all previous guesses are displayed", async () => {
        const guesses = [
            "HELLO",
            "WORLD",
            "TIGHT",
